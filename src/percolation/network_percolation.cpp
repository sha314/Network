...
#include "explosive/network_percolation_explosive.h"
...
//    cout << "original " << _randomized_link_indices << endl;
//    cout << "randomized " << _randomized_link_indices << endl;
}
...
void NetworkBApercolation::time_summary() {
