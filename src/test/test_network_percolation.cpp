...
//    NetworkBApercolationExplosive_v4 net(m*2, m, N, M);
    NetworkBApercolation_v4 net(m*2, m, N);
...
//    NetworkBApercolationExplosive_v4 net(m, m, N, M);
    NetworkBApercolation_v4 net(m, m, N);
